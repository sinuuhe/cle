...
function pagar(idpagoinscripcion) {
    var pagoinscripcion = {}
    $('.idpago-' + idpagoinscripcion).each(function () {
        pagoinscripcion[$(this).attr("data-var")] = $(this).text();
    });
    alertify.dialog('confirm').
		...
		<div class="form-group">\n\
			<label for="nombre-' + idpagoinscripcion + '" class="col-sm-3 control-label">Alumno</label>\n\
			<div class="col-sm-9">\n\
				<input id="nombre-' + idpagoinscripcion + '" disabled type="text" class="form-control" value="' + pagoinscripcion.nombre + '">\n\
			</div>\n\
		</div>\n\
		<div class="form-group">\n\
			<label for="matricula-' + idpagoinscripcion + '" class="col-sm-3 control-label">Matrícula</label>\n\
			<div class="col-sm-9">\n\
				<input id="matricula-' + pagoinscripcion.matricula + '" disabled type="text" class="form-control" value="' + pagoinscripcion.matricula + '">\n\
			</div>\n\
		</div>\n\
		<div class="form-group">\n\
			<label for="matricula-' + idpagoinscripcion + '" class="col-sm-3 control-label">Total a pagar</label>\n\
			<div class="col-sm-9">\n\
                            <div class="input-group">\n\
                                <div class="input-group-addon">$</div>\n\
				<input id="matricula-' + idpagoinscripcion+ '" disabled type="text" class="form-control" value="' + pagoinscripcion.total_pago + '">\n\
                            </div>\n\
                        </div>\n\
		</div>\n\
		<div class="form-group">\n\
			<label for="forma_pago-' + idpagoinscripcion + '" class="col-sm-3 control-label">Forma de pago</label>\n\
			<div class="col-sm-9">\n\
				<select id="forma_pago-' + idpagoinscripcion + '" class="form-control  idpago-' + idpagoinscripcion + '">\n\
                ...
                onok: function () {
                    $.post("../ajax/pago_inscripcion.php?op=pagar", {idpagoinscripcion: idpagoinscripcion, forma_pago: $("#forma_pago-" + idpagoinscripcion).val()},
                            function (e) {
                                try {
...
function ver_recibo(idpagoinscripcion) {
    $('<form>', {
        "method": "POST",
        "target": "_blank",
        "html": '<input type="hidden" id="id" name="id" value="' + idpagoinscripcion + '" />' +
                '<input type="hidden" id="concepto" name="concepto" value="Pago de Inscripción" />' +
                '<input type="hidden" id="tipo" name="formato" value="pago_inscripcion" />',
