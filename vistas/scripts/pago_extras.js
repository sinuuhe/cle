...
function pagar(idpagoextra) {
    var pagoextra = {}
    $('.idpago-' + idpagoextra).each(function () {
        pagoextra[$(this).attr("data-var")] = $(this).text();
    });
    alertify.dialog('confirm').
		...
		<div class="form-group">\n\
			<label for="nombre-' + idpagoextra + '" class="col-sm-3 control-label">Alumno</label>\n\
			<div class="col-sm-9">\n\
				<input id="nombre-' + idpagoextra + '" disabled type="text" class="form-control" value="' + pagoextra.nombre + '">\n\
			</div>\n\
		</div>\n\
		<div class="form-group">\n\
			<label for="matricula-' + idpagoextra + '" class="col-sm-3 control-label">Matrícula</label>\n\
			<div class="col-sm-9">\n\
				<input id="matricula-' + pagoextra.matricula + '" disabled type="text" class="form-control" value="' + pagoextra.matricula + '">\n\
			</div>\n\
		</div>\n\
		<div class="form-group">\n\
			<label for="matricula-' + idpagoextra + '" class="col-sm-3 control-label">Total a pagar</label>\n\
			<div class="col-sm-9">\n\
                            <div class="input-group">\n\
                                <div class="input-group-addon">$</div>\n\
				<input id="matricula-' + idpagoextra + '" disabled type="text" class="form-control" value="' + pagoextra.monto_pago + '">\n\
                            </div>\n\
                        </div>\n\
		</div>\n\
		<div class="form-group">\n\
			<label for="forma_pago-' + idpagoextra + '" class="col-sm-3 control-label">Forma de pago</label>\n\
			<div class="col-sm-9">\n\
				<select id="forma_pago-' + idpagoextra + '" class="form-control  idpago-' + idpagoextra + '">\n\
                ...
                onok: function () {
                    $.post("../ajax/pago_extras.php?op=pagar", {idpagoextra: idpagoextra, forma_pago: $("#forma_pago-" + idpagoextra).val()},
                            function (e) {
                                try {
...
function ver_recibo(idpagoextra) {
    $('<form>', {
        "method": "POST",
        "target": "_blank",
        "html": '<input type="hidden" id="id" name="id" value="' + idpagoextra + '" />' +
                '<input type="hidden" id="concepto" name="concepto" value="Pago de extra" />' +
                '<input type="hidden" id="tipo" name="formato" value="pago_extra" />',
