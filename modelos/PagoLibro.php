...
Class PagoLibro {
    ...
    public function descontar($id){
        $sql = "UPDATE libros SET cantidad =  cantidad - 1 WHERE id = '$id'";
        
        return ejecutarConsulta($sql);
    }
    
    public function insertar_salida($fecha_pago, $id_alumno, $id_libro){
        $sql = "INSERT INTO salidas (fecha,id_alumno,id_libro) VALUES ('$fecha_pago','$id_alumno','$id_libro')";
